...
export function IconCosine({ className, ...rest }: SVGAttributes<SVGSVGElement>) {
    return (
        <svg className={classNames("fill-transparent stroke-current", className)} viewBox="0 0 101 101" {...rest}>
            <path d="M88.3 139c11.6-34 23.8-35.6 35 0 10.5 33.2 23.4 34 35 0" transform="translate(-72.8 -88)" strokeWidth={4} />
