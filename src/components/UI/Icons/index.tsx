...
export function IconMountains({className, ...rest}: SVGAttributes<SVGSVGElement>) {
    return (
        <svg className={classNames("fill-transparent stroke-current strokeLinecap-round", className)} strokeLinecap="round" strokeLinejoin="round" strokeWidth={.8} viewBox="0 0 24 24" {...rest}>
