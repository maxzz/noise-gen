...
export function IconMountains({className, ...rest}: SVGAttributes<SVGSVGElement>) {
    return (
        <svg className={classNames("fill-transparent stroke-current stroke-linecap-round stroke-linejoin-round", className)} strokeLinecap="round" strokeLinejoin="round" strokeWidth={.8} viewBox="0 0 24 24" {...rest}>
